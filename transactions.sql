...
trafficSource.medium, geoNetwork.continent, fullvisitorid , Products, Products_Category
...
AND transactions.Products_Category = visits_products_category.Products_Category
ORDER BY CA DESC
